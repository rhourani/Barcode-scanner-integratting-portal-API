...
class FoodicsSubDrawer extends StatefulWidget {
  final VoidCallback goBack;

  FoodicsSubDrawer({this.goBack});
  _FoodicsSubDrawerState createState() => _FoodicsSubDrawerState();

}

class _FoodicsSubDrawerState extends State<FoodicsSubDrawer> {
            ...
            slivers: [
              SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    if (state.services.contains("ioifoodics.admin"))
                      _createItem(
                    ...
                    if (state.services.contains("ioifoodics.report"))
                      _createItem(
                          icon: Icons.supervised_user_circle,
                          text: 'Report',
                          onTap: () {
