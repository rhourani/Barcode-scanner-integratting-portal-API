...
class PropertySubDrawer extends StatefulWidget {
  final VoidCallback goBack;

  PropertySubDrawer({this.goBack});

  @override
  _PropertySubDrawerState createState() => _PropertySubDrawerState();
}

class _PropertySubDrawerState extends State<PropertySubDrawer> {
            ...
            slivers: [
              SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    if (state.services.contains("ioiproperty.bilding"))
                      _createItem(
                    ...
                    if (state.services.contains("ioiproperty.flat"))
                      _createItem(
