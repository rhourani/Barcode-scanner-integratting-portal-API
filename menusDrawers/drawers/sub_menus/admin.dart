...
class AdminSubDrawer extends StatefulWidget {
  final VoidCallback goBack;

  AdminSubDrawer({this.goBack});

  @override
  _AdminSubDrawerState createState() => _AdminSubDrawerState();
}

class _AdminSubDrawerState extends State<AdminSubDrawer> {
          ...
          return CustomScrollView(
            slivers: [
              SliverList(
                ...
                if (state.services.contains("ioiadmin.admin"))
                  _createItem(
                    ...
                    if (state.services.contains("ioiadmin.user"))
                      _createItem(
                          icon: Icons.supervised_user_circle,
                          text: 'User',
                          onTap: () {
                    ...
                    if (state.services.contains("ioiadmin.company"))
                      _createItem(
                          icon: Icons.supervised_user_circle,
                          text: 'Company',
                          onTap: () {
